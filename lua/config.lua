...
nvim.keymap =
{
    editor =
    {
        ...
        select_all                                   = '<C-a>',           -- Enter virtual mode and select all.

        delete                                       = 'd',               -- Delete with option.
        paste                                        = 'p',               -- Paste text to the right of the cursor
    ...
    tree =
    {
        ...
        copy                                         = 'y',               -- Set the file or directory to the copied buffer.
        cut                                          = 'x',               -- Set the file or directory to the cut buffer.
        paste                                        = 'p',               -- Push copied and cut buffer's items to current directory.

        move_to_recently_visited                     = 'u',               -- Go to path that recently visited.

        mark_or_unmark                               = '<Leader>',        -- Toggle mark item.
        cancel                                       = 'm',               -- Cancel marked, copied and cut items.
        shell_for_marked                             = 's',               -- Open the Shell then pass the marked items as parameters.
    }
}
...
nvim.setting =
{
    ...
    appearance =
    {
        ...
        highlight_line                               = true,              -- Enable the highlight for the line where cursor located.
