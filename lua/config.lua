...
nvim.keymap =
{
    editor =
    {
        ...
        intent_left              = '<',           -- Append a tab intent to the line begining in virtual mode and normal mode.
        intent_right             = '>',           -- Remove a tab intent to the line begining in virtual mode and normal mode.
