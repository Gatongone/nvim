...
local setup_scheme   = function(theme_name, config)
    ...
    theme.base   =
    {
        ...
        Title                               = { fg = c.soft_green, style = "bold" },
        Macro                               = { fg = c.magenta },
        ...
        NoiceCmdlinePopupBorder             = { fg = c.soft_green },
        NoiceCompletionItemKindDefault      = { fg = c.pink },
        DiagnosticSignWarn                  = { fg = c.bright_yellow },
        DiagnosticSignInfo                  = { fg = c.forest_green },
        DiagnosticVirtualTextWarn           = { fg = c.soft_yellow },
        DiagnosticVirtualTextInfo           = { fg = c.soft_green },
        DiagnosticVirtualTextError          = { fg = c.error_red },
        MsgArea                             = { fg = c.pink },

        -- Mason
        MasonNormal                         = { fg = c.fonreground },
        MasonHeader                         = { fg = c.milk, style = "bold" },
        MasonHeaderSecondary                = { fg = c.milk, style = "bold" },
        MasonHighlight                      = { fg = c.light_blue },
        MasonHighlightBlock                 = { fg = c.light_blue, style = "bold" },
        MasonHighlightBlockBold             = { fg = c.light_blue, style = "bold" },
        MasonHighlightSecondary             = { fg = c.blue_gray },
        MasonHighlightBlockSecondary        = { fg = c.blue_gray, style = "bold" },
        MasonHighlightBlockBoldSecondary    = { fg = c.blue_gray, style = "bold" },
        MasonLink                           = { fg = c.soft_green, style = "bold" },
        MasonMuted                          = { fg = c.pink, style = "bold" },
        MasonMutedBlock                     = { fg = c.comment, style = "bold" },
        MasonMutedBlockBold                 = { fg = c.comment, style = "bold" },
        MasonError                          = { fg = c.error_red, style = "bold" },
        MasonWarning                        = { fg = c.soft_yellow, style = "bold" },
        MasonHeading                        = { fg = c.soft_green, style = "bold" },

        -- Lazy
        LazyH1                              = { fg = c.light_blue, style = "bold" },
        LazyButton                          = { fg = c.milk, style = "bold" },
        LazyButtonActive                    = { fg = c.soft_green, style = "bold" },

        -- Netrw
        NetrwLink                           = { fg = c.soft_green, style = "bold" },
        NetrwFile                           = { fg = c.soft_yellow, style = "bold" },
        NetrwDirectory                      = { fg = c.light_blue, style = "bold" },
        NetrwCopied                         = { fg = c.soft_green, style = "bold" },
        NetrwCut                            = { fg = c.pink, style = "bold" },
        NetrwMarkFile                       = { fg = c.soft_yellow, style = "bold" },
    ...
    if config.transparent_mode then
        theme.base = vim.tbl_extend("force", theme.base,
            {
                Visual      = { bg = c.cover_light },
                MultiCursor = { bg = c.milk },
                Cursor      = { bg = c.milk },
                CursorLine  = { bg = c.cover_gray },
            })
    end
